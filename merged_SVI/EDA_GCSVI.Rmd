...
* These median income levels are based on data sourced from websites in the next sub-section.
```{r echo=FALSE}
...
ggplot(numchild_for_plot, aes(x=NumChildren, y=numBelow, fill=inc_type))+
  ...
  scale_fill_discrete(name="Median Income Percentile", 
                      labels=c("Below 60% Median Raleigh", 
                               "Below 60% Median Wake",
                               "Below 30% Median Raleigh",
