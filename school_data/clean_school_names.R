clean_school_names = function(school_col_df){
  ...
  rm_string <- c("n/a", "N/a", "N/A", "n/A", "na", "N?A",
                 ...
                 "Curtis School", "Lapetite", "Little Stepping Stones",
                 "Wake County", "Wake"
  )
  ...
  school_col_long = school_col_df %>% rename_at(vars(contains("School")),
            funs(str_replace(., ".*School", "school_names")))  
