...
<!-- to-do: put zip code map with labels here -->
...
Below shows the number of household units in each zip code that contains at least 5 TGCP client households.
...
<!-- Put explanation of prop hh served ranking here -->

```{r}

zip_choropleth(zip_code_rank_num_clients,
               zip_zoom = atleast5_zip,
               title    = "Ranking of Number of Households Served",
               legend   = "Rank", 
               num_colors = 9)
